...
実行日時: 2026-02-15 06:00 UTC
リージョン: ap-northeast-1 (東京)
アプリ名: e2e-202602150555
...
| F3 | all-logs ログストリーム作成 | ✅ PASS | ストリーム: 2026/02/15/e2e-202602150555/9dcad98ead964980b0ca0c712f078dde |
| F4 | error-logs ログストリーム作成 | ✅ PASS | ストリーム: 2026/02/15/e2e-202602150555/9dcad98ead964980b0ca0c712f078dde |
| F5 | JSON構造化ログ形式 | ✅ PASS | level/message/timestamp/category フィールド確認済み |
| F6 | ログストリーム命名規則 | ✅ PASS | `{yyyy/MM/dd}/{FunctionName}/{GUID}` 形式確認済み |
| F7 | Metric Filter 動作確認 | ✅ PASS | Metric Filter 設定確認済み（データポイント伝播待ち） |
...
| N4 | S3ログ配信パス確認 | ✅ PASS | 配信パス: AWSLogs/905418284336/ap-northeast-1/... |
| N5 | Terraform destroy クリーンアップ | ✅ PASS | 全14リソース削除完了（S3バケットは事前に空にして削除） |
